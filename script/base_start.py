...
# Modified to introduce lab brake system
# removed unnecessary code blocks based on VPA robots
...
class BaseControl:
    def __init__(self):
        ...
        self.odom_topic     = rospy.get_param('~odom_topic','odom') # check topic name is namespace
        ...
        # two topics for unlocking traction output
        self.estop          = True
        ...
        self.sub_e_stop_local   = rospy.Subscriber("local_brake", Bool, self.estop_local_cb, queue_size=1)
        ...
        if(self.pub_imu):            
            ...
            time.sleep(2.0) # move base imu initialization need about 2s,during initialization,move base system is blocked
