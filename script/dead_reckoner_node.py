...
class DeadReckonerNode:
    ...
    def __init__(self):
        ...
        self.ticks_per_rev = 13 * 45 * 4  # 13 ticks per motor rev, 45:1 gearbox, use 2 phase for 4x the resolution
        self.wheel_radius  = 0.0318
        self.wheel_base    = 0.105
        ...
        rospy.Subscriber("encoder_count", Float32MultiArray, self.encoder_cb, queue_size=1)
    ...
    def encoder_cb(self, msg: Float32MultiArray):
        
        self.curr_left_ticks  = msg.data[0]
        self.curr_right_ticks = msg.data[1]
